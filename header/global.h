...
{
	    CLASS_STAT("AGG_LIST", sizeof(AggregateListLogicalOperator) ),
		...
		CLASS_STAT("BIT_JOIN",sizeof(class BitJoinPhysicalOperator) ),
		...
		CLASS_STAT("EQJOIN",sizeof(class EQJoinLogicalOperator) ),
		CLASS_STAT("EXPR",sizeof(class EXPR) ),
		CLASS_STAT("FILE_SCAN",sizeof(class FileScanPhysicalOperator) ),
		CLASS_STAT("FILTER",sizeof(class FilterPhysicalOperator) ),
		CLASS_STAT("FUNC_OP",sizeof(class FunctionLogicalOperator) ),
		CLASS_STAT("GET",sizeof(class GetLogicalOperator) ),
		CLASS_STAT("GROUP",sizeof(class EXP_GROUP) ),
		CLASS_STAT("HASH_DUPLICATES",sizeof(class HashDuplicatesPhysicalOperator) ),
		CLASS_STAT("HGROUP_LIST", sizeof(class HashAggListPhysicalOperator) ),
		CLASS_STAT("INDEXED_FILTER", sizeof(class IndexedFilterPhysicalOperator) ),
		CLASS_STAT("KEYS_SET",sizeof(class KEYS_SET) ),
		CLASS_STAT("LEAF_OP",sizeof(class LeafOperator) ),
		CLASS_STAT("LOG_COLL_PROP",sizeof(class LOG_COLL_PROP) ),
		CLASS_STAT("LOG_ITEM_PROP",sizeof(class LOG_ITEM_PROP) ),
		CLASS_STAT("LOOPS_INDEX_JOIN",sizeof(class LoopsIndexJoinPhysicalOperator) ),
		CLASS_STAT("LOOPS_JOIN",sizeof(class LoopsJoinPhysicalOperator) ),
		CLASS_STAT("M_EXPR",sizeof(class M_EXPR) ),
		CLASS_STAT("M_WINNER",sizeof(class M_WINNER) ),
		CLASS_STAT("MERGE_JOIN",sizeof(class MergeJoinPhysicalOperator) ),
		CLASS_STAT("HASH_JOIN",sizeof(class HashJoinPhysicalOperator) ),
		CLASS_STAT("O_EXPR",sizeof(class O_EXPR) ),
		CLASS_STAT("O_GROUP",sizeof(class O_GROUP) ),
		CLASS_STAT("O_INPUTS",sizeof(class O_INPUTS) ),
		CLASS_STAT("P_FUNC_OP",sizeof(class FunctionPhysicalOperator) ),
		CLASS_STAT("P_PROJECT",sizeof(class ProjectPhysicalOperator) ),
		CLASS_STAT("PHYS_PROP",sizeof(class PHYS_PROP) ),
		CLASS_STAT("PROJECT",sizeof(class ProjectLogicalOperator) ),
		CLASS_STAT("QSORT",sizeof(class QsortPhysicalOperator) ),
		CLASS_STAT("RM_DUPLICATES",sizeof(class RMDuplicatesLogicalOperator) ),
		CLASS_STAT("SCHEMA", sizeof(class SCHEMA) ),
		CLASS_STAT("SELECT", sizeof(class SelectLogicalOperator) ),
